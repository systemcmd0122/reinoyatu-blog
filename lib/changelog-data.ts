...
export const changelogData: ChangelogEntry[] = [
  {
    ...
    items: [
      {
        category: "Design",
        content: "コードブロックUIの劇的な進化（Macスタイル）",
        description: "技術記事の読みやすさを追求し、コードブロックをMacのウィンドウ風のデザインに刷新しました。OS標準のようなトラフィックライト、プログラミング言語ごとのバッジ、そして直感的なアニメーション付きコピーボタンを搭載し、視覚的な楽しさと実用性を両立させました。",
      },
      {
        category: "Improvement",
        content: "インライン・プロフィール編集機能の導入",
        description: "プロフィール編集のために設定ページへ移動する手間を解消。プロフィールページから直接、ダイアログ形式で名前や自己紹介、SNSリンクを更新できるようになりました。シームレスな編集体験を提供します。",
      },
      {
        category: "Design",
        content: "「書く楽しさ」を表現した、可愛いローディングアニメーション",
        description: "無機質な読み込み画面を、ブログサイトらしい温かみのあるアニメーションに刷新。本とペンが躍動する可愛いアイコンと、遊び心のあるタイポグラフィで、ページ遷移の待機時間も心地よい体験に変えました。",
      },
      {
        category: "Improvement",
        content: "サイト全域にわたるUIの最終研磨",
        description: "細部の余白、フォントの太さ、ボタンの反応など、サイト全体の使い心地を再点検し、より洗練された「完璧なブログサイト」を目指して調整を行いました。",
      },
    ],
  },
  {
