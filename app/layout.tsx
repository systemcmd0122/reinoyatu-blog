...
const siteConfig = {
  title: "例のヤツ｜ブログ",
  description: "例のヤツを主催とした様々なことを投稿・共有するためのブログプラットフォームです。",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li><Link href="/guide/markdown" className="hover:text-primary transition-colors">マークダウンガイド</Link></li>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li><Link href="/login" className="hover:text-primary transition-colors">ログイン</Link></li>
                      <li><Link href="/signup" className="hover:text-primary transition-colors">新規登録</Link></li>
                    </ul>
                  </div>
                </div>
                <div className="border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
                  <div>© {new Date().getFullYear()} 例のヤツ｜ブログ. All Rights Reserved.</div>
                  <div className="flex items-center space-x-6">
                    <a href="https://twitter.com/reinoyatu" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">X (Twitter)</a>
